...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Map.year'
        db.add_column(u'Karamoja_map', 'year',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['Karamoja.Years']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Map.year'
        db.delete_column(u'Karamoja_map', 'year_id')
    ...
    models = {
        ...
        u'Karamoja.map': {
            ...
            'year': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['Karamoja.Years']"})
        },
        u'Karamoja.months': {
