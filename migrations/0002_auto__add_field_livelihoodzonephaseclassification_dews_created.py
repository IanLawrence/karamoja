...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LivelihoodZonePhaseClassification.dews_created'
        db.add_column(u'Karamoja_livelihoodzonephaseclassification', 'dews_created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 12, 19, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LivelihoodZonePhaseClassification.dews_created'
        db.delete_column(u'Karamoja_livelihoodzonephaseclassification', 'dews_created')
